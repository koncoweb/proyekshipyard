...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const title = 'Batang Shipyard Indonesia | Produksi Kapal Kayu, Dokumen, Perawatan, Kapal Bekas';
  const description = 'Galangan kapal di Indonesia: produksi kapal kayu, pengurusan dokumen (termasuk SPB), perawatan, dan fasilitasi jual-beli kapal bekas.';
  return {
    title, description,
    ...
    <>
      <section className="hero shipyard-hero">
        ...
        <div className="container hero-inner">
          ...
          <p className="hero-sub">Solusi lengkap untuk industri maritim: produksi kapal kayu berkualitas tinggi, pengurusan dokumen kapal, perawatan profesional, dan fasilitasi jual-beli kapal bekas.</p>
      ...
      <section className="list">
        <div className="card">
          ...
          <ul>
            ...
            <li><a href="/layanan/kapal-bekas">Second-Hand Vessel / Kapal Bekas</a></li>
          </ul>
        </div>
        <div className="card">
          <h2>FAQ</h2>
