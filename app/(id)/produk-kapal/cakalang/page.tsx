  ...
  return (
    <>
      <section className="hero light-text" style={{
        background:
          "linear-gradient(90deg, rgba(255,255,255,1) 0%, rgba(255,255,255,.85) 36%, rgba(255,255,255,.65) 60%, rgba(255,255,255,.45) 82%, rgba(255,255,255,.30) 100%), url('/images/cakalang/galangan-kapal-cakalang-jawatengah.jpeg') center / cover no-repeat"
      }}>
        <div className="container hero-inner" style={{padding:'98px 0 77px'}}>
          <div className="hero-copy">
            <p style={{fontWeight:800,margin:'0 0 8px'}}>Produk Kapal</p>
            <h1 className="hero-title">Kapal Cakalang</h1>
            <p className="hero-sub">Didesain untuk target tongkol/cakalang dengan haluan ramping, efisiensi bahan bakar, dan layout dek efektif.</p>
