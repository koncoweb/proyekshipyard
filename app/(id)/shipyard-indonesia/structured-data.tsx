export function StructuredData() {
  const data = [
    ...
    ...[
      ...
      { name:'Jual-Beli Kapal Bekas', url:'https://batangshipyard.com/layanan/kapal-bekas' },
    ].map(s => ({ '@context':'https://schema.org','@type':'Service', name:s.name, provider:{'@type':'Organization', name:'Batang Shipyard Indonesia'}, areaServed:'ID', url:s.url })),
    {
      ...
      mainEntity:[
        { '@type':'Question', name:'Apa layanan utama?', acceptedAnswer:{'@type':'Answer', text:'Produksi kapal kayu, dokumen kapal (termasuk SPB), perawatan kapal, dan jual-beli kapal bekas.'}},
